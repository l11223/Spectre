...
import me.yuki.spectre.util.PermissionRequestHandler
import me.yuki.spectre.util.PermissionUtils
...
import me.yuki.spectre.util.UpdateChecker
import me.yuki.spectre.ui.component.UpdateDialog

import androidx.compose.runtime.mutableStateOf
import androidx.compose.ui.platform.LocalContext
import android.provider.OpenableColumns
import me.yuki.spectre.ui.theme.ThemeManager
import me.yuki.spectre.ui.component.rememberLoadingDialog
import android.widget.Toast

import me.yuki.spectre.ui.screen.settings.ThemeImportDialog
import me.yuki.spectre.util.BiometricUtils
...
class MainActivity : AppCompatActivity() {
    ...
    override fun dispatchTouchEvent(ev: android.view.MotionEvent?): Boolean {
        if (ev?.action == android.view.MotionEvent.ACTION_UP) {
            if (me.yuki.spectre.ui.theme.SoundEffectConfig.scope == me.yuki.spectre.ui.theme.SoundEffectConfig.SCOPE_GLOBAL) {
                me.yuki.spectre.util.SoundEffectManager.play(this)
            }
        }
    ...
    override fun attachBaseContext(newBase: android.content.Context) {
        super.attachBaseContext(me.yuki.spectre.util.DPIUtils.updateContext(newBase))
    }
    ...
    private fun setupUI() {
        ...
        // Load DPI settings
        me.yuki.spectre.util.DPIUtils.load(this)
        me.yuki.spectre.util.DPIUtils.applyDpi(this)
        ...
        setContent {
            ...
            LaunchedEffect(Unit) {
                me.yuki.spectre.util.AppData.DataRefreshManager.ensureCountsLoaded()
                ...
                while (isActive) {
                    ...
                    try {
                        me.yuki.spectre.util.AppData.DataRefreshManager.ensureCountsLoaded(force = forceRefresh)
                    } catch (e: Exception) {
                ...
                LaunchedEffect(Unit) {
                    if (prefs.getBoolean("auto_update_check", true)) {
                        withContext(Dispatchers.IO) {
                             ...
                             val hasUpdate = me.yuki.spectre.util.UpdateChecker.checkUpdate()
                             if (hasUpdate) {
...
private fun BottomBar(navController: NavHostController) {
    ...
    val superuserCount by me.yuki.spectre.util.AppData.DataRefreshManager.superuserCount.collectAsState()
    val apmModuleCount by me.yuki.spectre.util.AppData.DataRefreshManager.apmModuleCount.collectAsState()
    val kernelModuleCount by me.yuki.spectre.util.AppData.DataRefreshManager.kernelModuleCount.collectAsState()
                ...
                if (show) {
                    key(destination) {
                        ...
                        NavigationBarItem(
                            ...
                            onClick = {
                                if (me.yuki.spectre.ui.theme.SoundEffectConfig.scope == me.yuki.spectre.ui.theme.SoundEffectConfig.SCOPE_BOTTOM_BAR) {
                                    me.yuki.spectre.util.SoundEffectManager.play(context)
                                }
