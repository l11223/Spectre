package me.yuki.spectre.ui.viewmodel
...
import me.yuki.spectre.IAPRootService
import me.yuki.spectre.Natives
import me.yuki.spectre.apApp
import me.yuki.spectre.services.RootServices
import me.yuki.spectre.util.APatchCli
import me.yuki.spectre.util.HanziToPinyin
import me.yuki.spectre.util.PkgConfig
        ...
        viewModelScope.launch(Dispatchers.IO) {
            try {
                ...
                withContext(Dispatchers.Main) {
                    android.widget.Toast.makeText(context, me.yuki.spectre.R.string.backup_success, android.widget.Toast.LENGTH_SHORT).show()
                }
            } catch (e: Exception) {
        ...
        viewModelScope.launch(Dispatchers.IO) {
            try {
                ...
                if (newConfigs.isNotEmpty()) {
                    ...
                    fetchAppList()
                    withContext(Dispatchers.Main) {
                        android.widget.Toast.makeText(context, me.yuki.spectre.R.string.restore_success, android.widget.Toast.LENGTH_SHORT).show()
                    }
                }
            } catch (e: Exception) {
