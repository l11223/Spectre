...
#define KERNELPATCH_DATA_DIR "/data/adb/.fk"
#define KERNELPATCH_MODULE_DATA_DIR KERNELPATCH_DATA_DIR "/kpm"
#define APD_PATH "/data/adb/.core"
#define ALL_ALLOW_SCONTEXT "u:r:su:s0"
#define ALL_ALLOW_SCONTEXT_MAGISK "u:r:su:s0"
