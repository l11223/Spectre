...
jlong nativeSu(JNIEnv *env, jobject /* this */, jstring super_key_jstr, jint to_uid, jstring selinux_context_jstr) {
    ...
    const auto super_key = JUTFString(env, super_key_jstr);
    // SECURITY (VULN-03): Store JUTFString as named variable to extend lifetime.
    // Previously, the temporary was destroyed before strncpy, causing use-after-free.
    JUTFString selinux_context_holder(env, selinux_context_jstr);
    const char *selinux_context = selinux_context_jstr ? selinux_context_holder.get() : nullptr;
...
jobject nativeSuProfile(JNIEnv *env, jobject /* this */, jstring super_key_jstr, jint uid) {
    ...
    jclass cls = env->FindClass("me/yuki/spectre/Natives$Profile");
...
jobject nativeControlKernelPatchModule(JNIEnv *env, jobject /* this */, jstring super_key_jstr, jstring module_name_jstr, jstring control_args_jstr) {
    ...
    jclass cls = env->FindClass("me/yuki/spectre/Natives$KPMCtlRes");
    jmethodID constructor = env->GetMethodID(cls, "<init>", "()V");
...
JNIEXPORT jint JNI_OnLoad(JavaVM* vm, void * /*reserved*/) {
    ...
    auto clazz = JNI_FindClass(env, "me/yuki/spectre/Natives");
    ...
    const static JNINativeMethod gMethods[] = {
        ...
        {"nativeCoreVersion", "(Ljava/lang/String;)J", reinterpret_cast<void *>(&nativeKernelPatchVersion)},
        {"nativeCoreBuildTime", "(Ljava/lang/String;)Ljava/lang/String;", reinterpret_cast<void *>(&nativeKernelPatchBuildTime)},
        ...
        {"nativeSuProfile", "(Ljava/lang/String;I)Lme/yuki/spectre/Natives$Profile;", reinterpret_cast<void *>(&nativeSuProfile)},
        {"nativeLoadModule", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)J", reinterpret_cast<void *>(&nativeLoadKernelPatchModule)},
        {"nativeControlModule", "(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Lme/yuki/spectre/Natives$KPMCtlRes;", reinterpret_cast<void *>(&nativeControlKernelPatchModule)},
        {"nativeUnloadModule", "(Ljava/lang/String;Ljava/lang/String;)J", reinterpret_cast<void *>(&nativeUnloadKernelPatchModule)},
        {"nativeModuleNum", "(Ljava/lang/String;)J", reinterpret_cast<void *>(&nativeKernelPatchModuleNum)},
        {"nativeModuleList", "(Ljava/lang/String;)Ljava/lang/String;", reinterpret_cast<void *>(&nativeKernelPatchModuleList)},
        {"nativeModuleInfo", "(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;", reinterpret_cast<void *>(&nativeKernelPatchModuleInfo)},
